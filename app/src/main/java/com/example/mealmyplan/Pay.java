...
public class Pay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter4 = new ArrayAdapter<String>(Pay.this, android.R.layout.simple_spinner_item, list4);
        ...
        bpay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(a==0){
                    ...
                    Toast.makeText(Pay.this, "calculate price " , Toast.LENGTH_SHORT).show();
                }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot1) {
                ...
                df1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        databaseReference.child("directOrder").child(userKey).setValue(save).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                             //   Toast.makeText(Pay.this,"Success ",Toast.LENGTH_LONG).show();
