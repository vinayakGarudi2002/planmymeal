...
public class VitaminAK extends AppCompatActivity {
    ListView listView;
    ListView AlistView;
    ListView BlistView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter
                simpleAdapter =
                new SimpleAdapter(getApplicationContext(), list, R.layout.list_row_items, from, to);

        SimpleAdapter
                simpleAdapter1 =
                new SimpleAdapter(getApplicationContext(), list, R.layout.list_row_items, afrom, to1);

        SimpleAdapter
                simpleAdapter2 =
                new SimpleAdapter(getApplicationContext(), list, R.layout.list_row_items, bfrom, to2);
