...
public class ChossePlan1 extends AppCompatActivity { /// ConfirmPlan


    Button  Btn1Month, Btn2Month, Btn3Month,Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(ChossePlan1.this,MainActivity.class);
                startActivity(i);
            }
        });
