...
public class BreakfastC extends AppCompatActivity {
    Faadp1 adapter;
    RecyclerView rcv;
    Button btn,btp;
    ArrayList<mode3> ab ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breakfast_c);
        ...
        btp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(BreakfastC.this,CPnew.class);
                startActivity(i);
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(adapter.list.size()<1){
                    Toast.makeText(BreakfastC.this,"Check at least 10 ",Toast.LENGTH_SHORT).show();
                    ...
                    dataReference = FirebaseDatabase.getInstance().getReference("customU").child(userKey).child("Bf");
                    ...
                    Intent i1=new Intent(getApplicationContext(),CPnew.class);
                    String s ="ok";
                    i1.putExtra("Bf",s);
                    startActivity(i1);
    ...
    private  void show(){
        ...
        FirebaseRecyclerOptions<mode3> options =
                new FirebaseRecyclerOptions.Builder<mode3>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("postc").child(Food).child("Bf"), mode3.class)
                        .build();
