...
public class LunchC extends AppCompatActivity {
    Faadp1 adapter;
    RecyclerView rcv;
    Button btn,btp;
    ArrayList<mode3> ab ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_c);
        ...
        btp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LunchC.this,CPnew.class);
                startActivity(i);
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(adapter.list.size()<0){
                    ...
                    Toast.makeText(LunchC.this,"Check at least 10 ",Toast.LENGTH_SHORT).show();
                    ...
                    dataReference = FirebaseDatabase.getInstance().getReference("customU").child(userKey).child("L");
                    ...
                    Intent i1=new Intent(LunchC.this,CPnew.class);
                    String s ="ok";
                    i1.putExtra("L",s);
                    startActivity(i1);
                }
    ...
    private  void show(){
        ...
        FirebaseRecyclerOptions<mode3> options =
                new FirebaseRecyclerOptions.Builder<mode3>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("postc").child(Food).child("L"), mode3.class)
                        .build();
